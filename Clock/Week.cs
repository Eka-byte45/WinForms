...
namespace Clock
{
	public class Week
	{
		...
		public /*.Windows.Forms.CheckedListBox*/ void Extract(System.Windows.Forms.CheckedListBox clb)
		{
		...
		public override string ToString()
		{
			...
			/*
			 * -----------------------------------
			 *~NOT - побитовое отрицание (инверсия - это унарная операция,при которой 1 заменяются на 0, а нули единицами)
